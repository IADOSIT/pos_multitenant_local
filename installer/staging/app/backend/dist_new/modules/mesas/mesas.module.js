...
exports.MesasModule = MesasModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([mesa_entity_1.Mesa, mesa_entity_1.MesaAsignacion, mesa_entity_1.MesaJunta])],
        controllers: [mesas_controller_1.MesasController],
        providers: [mesas_service_1.MesasService],
        exports: [mesas_service_1.MesasService],
    })
], MesasModule);
